...
def format_cve_table(cve: CVEInfo) -> Table:
    ...
    table.add_column("Vendor", justify="center", min_width=6)
    table.add_column("Product", justify="center", min_width=5)
...
def format_recent_cves_table(results: list[RecentExploitResult]) -> Table:
    ...
    table.add_column("#", justify="center", width=4)
    table.add_column("CVE ID", justify="center", min_width=14)
    table.add_column("Severity", justify="center", min_width=8)
